...
public class SeriesActivity extends AppCompatActivity {
	...
	private DatabaseReference fb = _firebase.getReference("movie");
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		ActionBarDrawerToggle _toggle = new ActionBarDrawerToggle(SeriesActivity.this, _drawer, _toolbar, R.string.app_name, R.string.app_name);
				...
				fb.addListenerForSingleValueEvent(new ValueEventListener() {
					...
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						for(int _repeat16 = 0; _repeat16 < (int)(length); _repeat16++) {
							value = list.get((int)number).get("type").toString();
	...
	public class Gridview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			View _view = _v;
			if (_view == null) {
				_view = _inflater.inflate(R.layout._drawer_series, null);
			}
			...
			Glide.with(getApplicationContext()).load(Uri.parse(list.get((int)_position).get("photo").toString())).into(imageview3);
